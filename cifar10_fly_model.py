...
def train(model, data_loader, num_epochs, learning_rate):
    ...
    for epoch in range(num_epochs):
        for i, (images, labels) in enumerate(data_loader):
            ...
            # convert original labels to fly labels
            # 1 - fly, 0 otherwise
...
def create_model(train_loader, num_epochs=2, learning_rate=0.01):
    ...
    It predicts whether an object (airplane, automobile, bird, 
    cat,deer,dog,frog,horse,ship,truck) can fly or not. 1 - fly, 0 - otherwise
